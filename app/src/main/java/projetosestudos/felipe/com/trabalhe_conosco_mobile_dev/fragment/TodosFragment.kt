...
class TodosFragment : Fragment() {
    ...
    private var mRecyclerTodos: RecyclerView? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        mRecyclerTodos = view.recyclerTodos

        mAdapterTransacoes = AdapterTransacoes(activity!!, mListTransactions)

        ViewCompat.setNestedScrollingEnabled(mRecyclerTodos!!, false)

        val linearLayoutManager = LinearLayoutManager(activity!!)
        linearLayoutManager.reverseLayout = true
        linearLayoutManager.stackFromEnd = true
        mRecyclerTodos!!.layoutManager = linearLayoutManager
        mRecyclerTodos!!.setHasFixedSize(true)
        mRecyclerTodos!!.adapter = mAdapterTransacoes
